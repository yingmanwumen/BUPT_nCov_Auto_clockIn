...
# 重要: CAS认证的跳转地址记录
SERVICE = 'http://my.bupt.edu.cn/system/resource/code/auth/clogin.jsp' #'https://app.bupt.edu.cn/a_bupt/api/sso/cas'#?redirect=https%3A%2F%2Fapp.bupt.edu.cn%2Fncov%2Fwap%2Fdefault%2Findex&from=wap'
