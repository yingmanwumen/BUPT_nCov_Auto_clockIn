...
logging.info('Authorizing for %s', USERNAME)
...
try:
    ...
    logging.debug('Post %s, responce: %s', LOGIN_URL, response)


    logging.info('Authorize success')
...
###############################################################################
    ...
    logging.info('Form: area: %s, in school: %s', AREA ,bool(SFZX))
    logging.debug(data)
